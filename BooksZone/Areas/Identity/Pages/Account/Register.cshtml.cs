...
namespace BooksZone.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser //Created a user obj
                {
                ...
                if (result.Succeeded)
                {
                    ...
                    //Here we will first check the role exists in the DB if not i will create it.(In Order to do that we need role manager)
